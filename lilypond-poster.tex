...
\includegraphics[width=20cm]{templates/a0poster-landscape/figures/logo.png} % Logo or a photo of you, adjust its dimensions here
\end{minipage}
...
\includegraphics[width=0.8\linewidth]{templates/a0poster-landscape/figures/placeholder}
